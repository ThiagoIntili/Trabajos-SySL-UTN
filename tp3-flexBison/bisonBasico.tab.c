...
#line 22 "bisonBasico.y"
    {printf("el id es: %s de longitud: %d ",yytext,yyleng);if(yyleng>10) yyerror("metiste la pata");;}
    break;
...
#line 28 "bisonBasico.y"
    {printf("valores %d ",atoi(yytext),(yyvsp[(1) - (1)].num)); ;}
    break;



/* Line 1455 of yacc.c  */
#line 1357 "bisonBasico.tab.c"
      default: break;
    }
