...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ASIGNACION = 3,                 /* ASIGNACION  */
  YYSYMBOL_PYCOMA = 4,                     /* PYCOMA  */
  YYSYMBOL_SUMA = 5,                       /* SUMA  */
  YYSYMBOL_RESTA = 6,                      /* RESTA  */
  YYSYMBOL_PARENIZQUIERDO = 7,             /* PARENIZQUIERDO  */
  YYSYMBOL_PARENDERECHO = 8,               /* PARENDERECHO  */
  YYSYMBOL_ID = 9,                         /* ID  */
  YYSYMBOL_CONSTANTE = 10,                 /* CONSTANTE  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_sentencias = 12,                /* sentencias  */
  YYSYMBOL_sentencia = 13,                 /* sentencia  */
  YYSYMBOL_14_1 = 14,                      /* $@1  */
  YYSYMBOL_expresion = 15,                 /* expresion  */
  YYSYMBOL_primaria = 16,                  /* primaria  */
  YYSYMBOL_operadorAditivo = 17            /* operadorAditivo  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASIGNACION", "PYCOMA",
  "SUMA", "RESTA", "PARENIZQUIERDO", "PARENDERECHO", "ID", "CONSTANTE",
  "$accept", "sentencias", "sentencia", "$@1", "expresion", "primaria",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* $@1: %empty  */
#line 25 "bisonBasico.y"
              { printf("el id es: %s de longitud: %d ", (yyvsp[0].cadena), yyleng); if (yyleng>10) yyerror("metiste la pata"); /* declarar/insertar variable en tabla (detecta redeclaracion) */ detectar_redeclaracion((yyvsp[0].cadena)); free((yyvsp[0].cadena)); }
#line 1086 "bisonBasico.tab.c"
    break;

  case 8: /* primaria: ID  */
#line 30 "bisonBasico.y"
             { /* uso de variable en expresion: verificar declaracion previa */ detectar_uso_no_declarado((yyvsp[0].cadena)); free((yyvsp[0].cadena)); }
#line 1092 "bisonBasico.tab.c"
    break;

  case 9: /* primaria: CONSTANTE  */
#line 31 "bisonBasico.y"
            { printf("valores %d ", (yyvsp[0].num)); }
#line 1098 "bisonBasico.tab.c"
    break;


#line 1102 "bisonBasico.tab.c"
